...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            <a href="{{ route('employee.pay-slips.index') }}" class="text-indigo-600 hover:text-indigo-900">← Back to Pay Slips</a>
        </div>
                ...
                <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                    ...
                    @if($paySlip->file_path)
                        <div>
                            ...
                            <dd class="mt-1">
                                <a href="{{ route('employee.pay-slips.download', $paySlip) }}" class="text-indigo-600 hover:text-indigo-900">
                                    Download PDF
                                </a>
                            </dd>
                        </div>
