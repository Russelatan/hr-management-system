...
@section('content')
    <x-page-header title="Pay Slip Details">
        <x-slot:actions>
            <x-button variant="secondary" :href="route('employee.pay-slips.index')">
    ...
    <div class="space-y-6">
            ...
            <dl class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
                ...
                @if($paySlip->file_path)
                    <div class="sm:col-span-2">
                        ...
                        <dd class="mt-1">
                            <a href="{{ route('employee.pay-slips.download', $paySlip) }}" class="inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">
        ...
        @if($paySlip->computation_notes)
            ...
            <x-card>
                <h3 class="mb-4 text-base font-semibold text-gray-900 dark:text-gray-100">Salary Breakdown</h3>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between border-b border-gray-100 pb-3 dark:border-gray-700">
                        <span class="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <span class="ml-1 text-xs text-gray-400 dark:text-gray-500">({{ $notes['absent_days'] }} day(s))</span>
                        </span>
